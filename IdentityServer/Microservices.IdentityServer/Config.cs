        ...
        public static IEnumerable<Client> Clients =>
            new Client[]
            {
                ...
                new Client()
                {
                    ...
                    RefreshTokenExpiration = TokenExpiration.Absolute,    //Refresh Token Absolute-sliding
                    AbsoluteRefreshTokenLifetime = (int)(DateTime.Now.AddDays(60)- DateTime.Now).TotalSeconds,   //Refresh Token Ömrü
                    RefreshTokenUsage = TokenUsage.ReUse   //Refresh Token Geçerli Olduğu Sürece Sürekli Kullanılabilir
                }
            };
    }
}